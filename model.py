...
class User(db.Model):
    ...
    def __repr__(self):
        ...
        return ("<User user_id={} first_name={} last_name={} email={}>"
            .format(self.user_id, self.fname, self.lname, self.email))
...
class Rating(db.Model):
    ...
    user_id = db.Column(db.relationship('User'), nullable=False)
    ...
    def __repr__(self):
        """Provide helpful representation when printed."""
        return ("<Report ID report_id={} user_id={} date_time={} location={} witness={} anonymous={} incident_descrip={}>"
            .format(self.report_id, self.user_id, self.date_time self.location, self.witness,self.anonymous, self.incident_descrip))
